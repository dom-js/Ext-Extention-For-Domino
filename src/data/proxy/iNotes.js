 ...
 */
Ext.define('Domino.data.proxy.iNotes', {
    ...
    config: {
        /**
        *@cfg {String} formname
        *iNotes访问时使用的显示表单，默认视图访问使用s_JSONPViewList,names查询使用s_ValidationJSONP
        */
        form: 's_JSONPViewList',
    ...
    buildUrl: function(request) {
        var me      = this,
            reader = me.getReader(), 
            form = reader.alias[0]==="reader.inames"?"s_ValidationJSONP":"s_JSONPViewList",
            url     =    "//"+me.config.host+"/inotes/forms8.nsf/iNotes/Proxy/?Open&Form="+form , //me.callParent(arguments),
